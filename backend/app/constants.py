...
DOC_CATEGORY_SALES = "sales"
DOC_CATEGORY_INVOICES = "invoices"
VALID_DOC_CATEGORIES = frozenset(
    {DOC_CATEGORY_FIELD, DOC_CATEGORY_PERMIT, DOC_CATEGORY_SALES, DOC_CATEGORY_INVOICES}
)
...
USER_TASK_TITLE_MAX = 255
USER_TASK_NOTE_MAX = 8000

NOTIFICATION_TYPE_BILLING = "billing"
VALID_NOTIFICATION_TYPES = frozenset({NOTIFICATION_TYPE_BILLING})

USER_TASK_ATTACHMENT_KIND_IMAGE = "image"
USER_TASK_ATTACHMENT_KIND_PDF = "pdf"
VALID_USER_TASK_ATTACHMENT_KINDS = frozenset({
    USER_TASK_ATTACHMENT_KIND_IMAGE,
    USER_TASK_ATTACHMENT_KIND_PDF,
})

USER_TASK_NOTIFICATION_EVENT_COMPLETED = "completed"
USER_TASK_NOTIFICATION_EVENT_REASSIGNED = "reassigned"
VALID_USER_TASK_NOTIFICATION_EVENTS = frozenset({
